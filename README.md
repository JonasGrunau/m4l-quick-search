...
> ℹ️ The page populates a second or so after load — it first waits for a Max bridge, then falls back to mock data. (The real device instead loads `html/index.html` live, driven by the v8 brain.)
